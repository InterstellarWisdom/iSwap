...
public class Nrc20Token implements Contract, Token {
    ...
    public Nrc20Token(@Required String name, @Required String symbol, @Required BigInteger initialAmount, @Required int decimals) {
        this.name = name;
        this.symbol = symbol;
