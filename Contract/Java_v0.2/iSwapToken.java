...
public class iSwapToken implements Token {
    ...
    public iSwapToken(@Required String name, @Required String symbol, @Required BigInteger initialAmount, @Required int decimals) {
        this.name = name;
        this.symbol = symbol;
    ...
    public void mint(Address address, BigInteger value){
//        require(Msg.sender().toString().equals(Msg.sender().toString()),"forbid");
        addBalance(address,value);
    }

    public void burn(Address address, BigInteger value){
//        require(Msg.sender().toString().equals(Msg.sender().toString()),"forbid");
        subtractBalance(address,value);
    }
