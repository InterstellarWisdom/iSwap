  ...
  <div>
    <div class="text-left head">
      ...
      <div class="balance-amount">
        <span class="balance-amount__title">Balance:</span>
        <TokenBalance :contractAddress="fromToken.address"></TokenBalance>
      </div>
    </div>
    <div class="swap__from">
      ...
      <div class="swap__amount">
        <input type="text" placeholder="0.00" :value="amountIn" @input="handleInput" />
      </div>
    </div>
  </div>
</template>
<script lang="ts">
  import { AssetFromSelectTs } from "./AssetFromSelectTs"
  export default AssetFromSelectTs
</script>
<style lang="less" scoped>
  @import url("./AssetFromSelect.less");
</style>