...
<script lang="ts">
  import { SwapTs } from "./SwapTs"
  export default SwapTs
</script>
<style lang="less" scoped>
  @import url("./Swap.less");
</style>